...
The pinout is arranged left-to-right to match the physical LED head: UVA on the left, shared power/ground/data through the center, and IR on the right. Use a cable orientation that maps pin 1 to pin 1. Mark pin 1 on the 3D shell before final assembly.
