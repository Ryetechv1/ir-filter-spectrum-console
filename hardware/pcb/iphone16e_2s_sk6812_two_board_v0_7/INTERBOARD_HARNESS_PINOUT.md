...
The pinout is arranged left-to-right to match the physical LED head: UVA on the left, shared power/ground/data through the center, and IR on the right. Pins 8, 11, 12, 13, and 14 are intentionally spare after removing the transparent OLED. Use a straight pin-1-to-pin-1 harness. Mark pin 1 on the 3D shell before final assembly.
