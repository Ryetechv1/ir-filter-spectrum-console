...
- M5Stack Unit Glass I2C is routed from ESP32-CAM IO15/IO16 through the JST-GH inter-board harness to the head-board J2 connector.
...
- D8: firmware logical LED power state. No high-side load switch is populated on v0.6.

## ESP32-CAM Added Signals

- IO15: Unit Glass I2C SDA to harness pin 8.
- IO16: Unit Glass I2C SCL to harness pin 11.
