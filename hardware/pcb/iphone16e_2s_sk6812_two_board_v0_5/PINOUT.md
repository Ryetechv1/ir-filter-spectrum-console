...
- M5Stack Unit Glass I2C is routed from ESP32-CAM IO15/IO16 through the FFC to the head-board J2 connector.
- J8 is the 14-pin FFC connector to the compact LED/lens head board.
...
- D7: SK6812 RGBW data to FFC pin 7 through R7.
- D8: firmware logical LED power state. No high-side load switch is populated on v0.5.

## ESP32-CAM Added Signals

- IO15: Unit Glass I2C SDA to FFC pin 8.
- IO16: Unit Glass I2C SCL to FFC pin 11.
- Keep IO12 unused for this add-on because it is a boot-strapping pin.
...
- The 14-pin FFC connector sits along the bottom edge of the head board.
- J2 is the 4-pin Unit Glass connector: GND, 5V, SDA, SCL.
- The fab layer includes a 42.04 x 27.22 mm Unit Glass outline and a 35.05 x 18 mm display-area outline for the printed camera chamber.
