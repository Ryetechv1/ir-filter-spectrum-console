...
This is a planning BOM delta for the S3/C6 hologram update. Use the v0.8 BOM/CPL files as the electrical baseline for resistors, MOSFETs, SK6812 LEDs, IR/UVA LED channels, battery input, buck/charger module pads, and Nano carrier components.
...
|---:|---|---|
| 1 | Arduino Nano | LED driver controller retained. |
| 1 | 2S 7.4 V 450 mAh LiPo pack | OVONIC long pack target, XT30 plug. |
| 1 | 5 V buck regulator | Size/rating must support Nano, S3/C6 if rail-powered, and LED load. |
